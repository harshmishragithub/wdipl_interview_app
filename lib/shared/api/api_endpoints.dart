class ApiEndpoints {
  ...
  static const baseurl = //"https://admin.tanami.betadelivery.com/api/v1/";
      "http://192.168.50.90/laravel_test/public/api/";
  ...
  static const sendlogoqapi = "${baseurl}store_user_logical_que_ans";
  static const sendtechemhapi =
      "${baseurl}store_user_que_ans"; //"${baseurl}get_source";
}
